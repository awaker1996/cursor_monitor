...

{
  ...
  assert('include grok-bot cycle tokens', withBot.metrics.autoTokens === 10_000);
  assert(
    'include grok-bot today percent',
    approx(withBot.metrics.autoTodayUsedPercent, 4.8),
  );
}
